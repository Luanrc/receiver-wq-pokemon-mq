...
class TransfersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create transfer" do
    assert_difference('Transfer.count') do
      post transfers_url, params: { transfer: { pokemon: @transfer.pokemon, trainer: @transfer.trainer } }
    end
  ...
  test "should update transfer" do
    patch transfer_url(@transfer), params: { transfer: { pokemon: @transfer.pokemon, trainer: @transfer.trainer } }
